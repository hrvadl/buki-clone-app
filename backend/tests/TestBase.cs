...
public class TestBase
{
    ...
    private MyDbContext CreateDbContext()
    {
        ...
        var student = new UserEntity { Email = "student@test.com", Description = "Some description", Id = 1, Role = UserRole.Student, Password = "123", Number = "0660800552", Ads = new List<AdEntity>() { studentAd }, RecievedReviews = new List<ReviewEntity>() { teacherReviews } };
        var teacher = new UserEntity { Email = "teacher@test.com", Description = "Some description for teacher", Id = 2, Role = UserRole.Teacher, Password = "123", Number = "0660800553", Ads = new List<AdEntity>() { teacherAd }, GivenReviews = new List<ReviewEntity>() { teacherReviews } };
