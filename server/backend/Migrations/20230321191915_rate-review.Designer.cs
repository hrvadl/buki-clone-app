...
namespace buki_api.Migrations
{
    ...
    [Migration("20230321191915_rate-review")]
    partial class ratereview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdEntityUserEntity", b =>
                {
                    ...
                    b.HasKey("FavoritesId", "LikedById");
            ...
            modelBuilder.Entity("AdEntityUserEntity", b =>
                {
                    b.HasOne("buki_api.entities.AdEntity", null)
                        .WithMany()
